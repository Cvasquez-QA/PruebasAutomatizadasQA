...
title TestCafe - PosHgi360 (por partes)
cd /d "%~dp0.."
...
set BASE_REP=Reportes/Hgi360/Pos
set BASE_SRC=PosHgi360
...
echo ========================================
echo PosHgi360 - ejecucion por partes
...
echo 13/19 Reportes
echo ========================================
call node_modules\.bin\testcafe chrome "%BASE_SRC%/Reportes" %TC_OPTS% --reporter html:%REP_REP%/Reportes_%FECHA%.html
if errorlevel 1 set FAILED=1
call "%~dp0_Limpiar-Chrome-TestCafe.bat"
...
echo 14/19 IA
echo ========================================
call node_modules\.bin\testcafe chrome "%BASE_SRC%/6.IA" %TC_OPTS% --reporter html:%REP_IA%/IA_%FECHA%.html
if errorlevel 1 set FAILED=1
call "%~dp0_Limpiar-Chrome-TestCafe.bat"
...
echo ========================================
call node_modules\.bin\testcafe chrome "%BASE_SRC%/Facturacion Electronica" %TC_DOCS% --reporter html:%REP_FE%/FacturacionElectronica_%FECHA%.html
if errorlevel 1 set FAILED=1
call "%~dp0_Limpiar-Chrome-TestCafe.bat"
...
echo ========================================
if %FAILED% EQU 0 (
    echo PosHgi360 finalizo correctamente.
    set RESULTADO=OK
) else (
    echo PosHgi360 finalizo con errores en una o mas partes.
...
echo Reportes en: Reportes\Hgi360\Pos\*\%FECHA%\
...
(
  ...
  echo Hora fin: %HORA_FIN%
  echo Duracion: %DURACION%
  echo Reportes: Reportes\Hgi360\Pos\*\%FECHA%\
  echo ========================================
) >> "%LOG%"
