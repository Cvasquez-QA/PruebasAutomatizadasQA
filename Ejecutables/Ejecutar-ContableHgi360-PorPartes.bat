...
title TestCafe - ContableHgi360 (por partes)
cd /d "%~dp0.."
...
set BASE_REP=Reportes/Hgi360/Contable
set BASE_SRC=ContableHgi360
...
echo ========================================
echo ContableHgi360 - ejecucion por partes
...
echo ========================================
if %FAILED% EQU 0 (
    echo ContableHgi360 finalizo correctamente.
    set RESULTADO=OK
) else (
    echo ContableHgi360 finalizo con errores en una o mas partes.
...
echo Reportes en: Reportes\Hgi360\Contable\*\%FECHA%\
...
(
  ...
  echo Hora fin: %HORA_FIN%
  echo Duracion: %DURACION%
  echo Reportes: Reportes\Hgi360\Contable\*\%FECHA%\
  echo ========================================
) >> "%LOG%"
