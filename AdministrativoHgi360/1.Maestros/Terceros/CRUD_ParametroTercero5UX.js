...
fixture `CRUD_ParametroTercero5UX - Hgi360 Admin`
    .page(hgiAdminConfig.pagina);

test('Prueba PARAMETRO TERCERO 5 Hgi360 Admin CRUD - Hgi360 Admin', async t => {
    await ejecutarPruebaParametroTercero5(t, hgiAdminConfig);
});
